...
<body>
    ...
    <div class="geral">
        <div class="imagem">
            ...
            <img src="assets/img/infantis/pinóquio.jpeg" alt = "Pinóquio" height="700" width="450">
          </div>  
          ...
          <div class="texto">
            ...
            <p>Numa antiga carpintaria vivia Gepeto, um bom homem que passava o dia trabalhando e cujo único desejo era ter um filho. Com esse grande desejo, ele partiu para fazer uma boneca de madeira o mais fiel possível à imagem de uma criança. Ele passou muitos dias completamente imerso nesse trabalho, mas não perdeu nem o menor detalhe. Quando ele terminou, ele ficou tão satisfeito e feliz com o resultado que decidiu dar um nome: ele chamou de Pinóquio.</p>
            <div>
                <button class="baixar"> 
                    <a href=""> <i class="fa-light fa-down-to-line"></i>Ler livro </a>
                 </button>
                </div>
           </div>
